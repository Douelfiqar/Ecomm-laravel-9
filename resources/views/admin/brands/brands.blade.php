                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex d-flex justify-content-center align-items-center">
                                    ...
                                    <a href="{{url('/admin/deleteBrand/'.$brand->id)}}" class="btn btn-danger"><img src="https://img.icons8.com/plasticine/100/000000/filled-trash.png" width="25px"/></a>
                ...
                <div class="box">
                    <form action="{{route('admin.addBrand')}}" method="POST" style="padding: 20px" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                         ...
                         <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="brandNameFr">
                       </div>
                       <div class="input-group mb-3">
                         <span class="input-group-text" id="basic-addon1">Brand Name En</span>
                         <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="brandNameEn">
                       </div>
                       <div class="input-group mb-3">
