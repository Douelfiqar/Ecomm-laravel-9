            ...
            <div class="box-header">
                ...
                <div class="box">
                    <form action="{{route('admin.addSubCategory')}}" method="POST" style="padding: 20px" enctype="multipart/form-data">
                       ...
                       <div class="input-group mb-3">
                         <span class="input-group-text" id="basic-addon1">Sub Category Image</span>
                         <input type="file" class="form-control" aria-label="Username" aria-describedby="basic-addon1" name="SubCategoryImage">
                       </div>
