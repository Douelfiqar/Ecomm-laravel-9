...
<script>
            ...
            users += `<tr>                       
                                    <th scope="row"><img src="{{asset('upload/clientPhoto/${value.profile_photo_path}')}}" class="img-fluid rounded-start" alt="..." style="width:60X;height:60px;object-fit: contain;"></th>
